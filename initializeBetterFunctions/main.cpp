...
void initialGrid(std::vector<State> *stateVector)
{
    ...
    //std::cout <<"Left of Original Vacancy: "<< (*stateVector)[stateV_num_coord_map[12]].state_type<< std::endl;
    //std::cout <<"Vacancy: "<< (*stateVector)[stateV_num_coord_map[22]].state_type<< std::endl;
}

void updateSystem(std::vector<State> *stateVector, int transCoord, int VCoord)
{
    ...
    int elm_num = stateV_num_coord_map[transCoord];
    int V_elm_num = stateV_num_coord_map[VCoord];
...
int main()
{
    ...
    initialGrid(&stateVector);
    visualizeGrid(&stateVector);
    
    //update Grid works!
    updateSystem(&stateVector, 12 , 22);
